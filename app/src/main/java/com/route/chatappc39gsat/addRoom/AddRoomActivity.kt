...
import com.route.chatappc39gsat.ui.theme.black3
import com.route.chatappc39gsat.utils.ChatAuthTextField
import com.route.chatappc39gsat.utils.ChatToolbar
import androidx.lifecycle.viewmodel.compose.viewModel
import com.route.chatappc39gsat.ui.theme.gray2
import com.route.chatappc39gsat.utils.CreateButton
...
fun AddRoomContent(viewModel: AddRoomViewModel = viewModel(), onFinish: () -> Unit) {
    ...
    // MVI <-> Add-on UI Architecture
    // interface callback
    // Introductions to MVI <->(Model - View - Intent) UI architeture pattern
    // Activity or fragment ->  View Model (Actions)
    //                                       API calls -> Loading or Success or Error
    //  
    // ViewModel -> Activity or fragment (Events and States)
